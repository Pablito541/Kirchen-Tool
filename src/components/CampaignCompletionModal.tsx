                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-3">
                            <label className="text-sm font-bold text-zinc-900 flex items-center gap-2">
                                <span className="bg-zinc-100 text-zinc-500 w-6 h-6 rounded-full flex items-center justify-center text-xs">1</span>
                            ...
                            <textarea
                                ...
                                className="w-full min-h-[100px] p-4 bg-zinc-50 rounded-2xl border-none focus:ring-2 ring-zinc-100 resize-none text-zinc-700 font-medium"
                        ...
                        <div className="space-y-4">
                            <label className="text-sm font-bold text-zinc-900 flex items-center gap-2">
                                <span className="bg-zinc-100 text-zinc-500 w-6 h-6 rounded-full flex items-center justify-center text-xs">2</span>
                            ...
                            {formData.goals_reached !== null && (
                                <div className="animate-in fade-in slide-in-from-top-2 pt-2">
                                    <label className="text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2 block ml-1">
                                        {formData.goals_reached ? 'Was war der Schlüsselfaktor?' : 'Woran hat es gelegen?'}
                                    </label>
                                    <textarea
                                        value={formData.goals_reached_reason}
                                        onChange={(e) => setFormData({ ...formData, goals_reached_reason: e.target.value })}
                                        className="w-full min-h-[80px] p-4 bg-zinc-50 rounded-2xl border-none focus:ring-2 ring-zinc-100 resize-none text-zinc-700 font-medium text-sm"
                        ...
                        <div className="space-y-3">
                            <label className="text-sm font-bold text-zinc-900 flex items-center gap-2">
                                <span className="bg-zinc-100 text-zinc-500 w-6 h-6 rounded-full flex items-center justify-center text-xs">3</span>
                            ...
                            <textarea
                                ...
                                className="w-full min-h-[100px] p-4 bg-zinc-50 rounded-2xl border-none focus:ring-2 ring-zinc-100 resize-none text-zinc-700 font-medium"
                                placeholder="Was können wir beim nächsten Mal besser machen?"
                            />
                        </div>
                        ...
                        >
                            {loading ? 'Speichere...' : 'Kampagne abschließen'}
                        </Button>
                    </div>
                </Dialog.Content>
            </Dialog.Portal>
